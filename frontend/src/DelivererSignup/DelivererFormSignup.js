...
import useForm from "./useDelivererForm";
...
const FormSignup = ({ submitForm }) => {
    ...
    if (isSignedIn) {
        history.replace("/DelivererLanding");
        window.location.href = "/DelivererLanding";
    }
        ...
        <div className="signup-form-container">
            <form onSubmit={handleSubmit} className="signup-form" noValidate>
                <h1 className="signup-form-h1">
                    Sign up as a delivery person and start delivering food today!
                </h1>
