...
const Profile = ({ submitForm }) => {
    ...
    useEffect(() => {
        async function getInfo() {
            const response = await request(axios.get, "/deliverer/account");
    ...
    useEffect(() => {
        async function deleteAccountRequest() {
            const response = await request(axios.delete, "/deliverer/account");
        }
            ...
            <div className="profile-container ">
                <form onSubmit={handleSubmit} className="profile" noValidate>
                    ...
                    <br />
                        ...
                        />
                        {errors.pNumber && <h2>{errors.pNumber}</h2>}
                        </div>
                    <br />
                    <div className="profile-inputs">
                        <ProfileBlackTextField
                    ...
                    >
                        ...
                        <DialogContent>
                            <DialogContentText id="alert-dialog-description">
                                Your account and all of the delivery work, as well as any ongoing 
                                orders will be deleted. This action cannot
                                be undone.
                            </DialogContentText>
                        </DialogContent>
                        <DialogActions>
                    ...
                    <Button
                        ...
                        onClick={() => {
                            ...
                            values.pNumber = document.getElementById(
                                "phone-number-field"
                            ).value;
